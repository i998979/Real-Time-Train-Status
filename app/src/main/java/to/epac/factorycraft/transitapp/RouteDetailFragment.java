...
public class RouteDetailFragment extends Fragment {
    ...
    private Bitmap combineViewsToBitmap(View headerView, View contentContainer, View footerView) {
        ...
        int contentBgColor = Utils.getThemeColor(requireContext(), com.google.android.material.R.attr.colorOnPrimary);
        int secondaryBgColor = Utils.getThemeColor(requireContext(), com.google.android.material.R.attr.colorSecondary);
