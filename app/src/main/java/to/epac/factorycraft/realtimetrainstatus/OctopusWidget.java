...
public class OctopusWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent intent = pm.getLaunchIntentForPackage(MainActivity.OCTOPUS_PACKAGE);
            ...
            if (intent != null) {
                ...
                Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + MainActivity.OCTOPUS_PACKAGE));
                PendingIntent pendingIntent = PendingIntent.getActivity(
