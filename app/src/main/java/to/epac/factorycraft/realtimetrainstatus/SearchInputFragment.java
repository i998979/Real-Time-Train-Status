...
public class SearchInputFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnSwap.setOnClickListener(v -> {
            ...
            updateStationText(tvOrigin, selectedOriginID, "出發地");
            updateStationText(tvDest, selectedDestID, "目的地");
    ...
    private void updateStationText(TextView textView, String stationId, String defaultHint) {
        if (stationId != null) {
            int index = stationIDs.indexOf(Integer.parseInt(stationId));
            if (index != -1) {
                textView.setText(stationNames.get(index));
            }
        } else {
